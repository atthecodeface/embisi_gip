...
enum
{
    ...
    io_parallel_cfd_ctl_out_state_override_start_bit         = 13,
    io_parallel_cfd_data_out_enable_start_bit                = 17,
    io_parallel_cfd_data_out_use_ctl3_start_bit              = 18,
    io_parallel_cfd_ctl_oe01_start_bit                       = 19,
    io_parallel_cfd_ctl_oe23_start_bit                       = 21,
};
