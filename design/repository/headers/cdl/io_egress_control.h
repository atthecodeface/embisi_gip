    ...
    )
{
    ...
    timing to rising clock int_clock postbus_fifo_op, postbus_fifo_address_from_read_ptr, postbus_fifo_op_to_cmd;
    timing to rising clock int_clock postbus_sram_data_op, postbus_sram_address_op;

    timing from rising clock int_clock egress_fifo_op, egress_fifo_op_to_cmd, egress_fifo_address_from_read_ptr, egress_fifo_to_access;
