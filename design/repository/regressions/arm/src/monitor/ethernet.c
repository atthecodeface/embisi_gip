 ...
 */
static int command_io_fifo_status( int argc, unsigned int *args )
{
    unsigned int s;
    int i;
...
/*f command_io_fifo_get_status
  ...
  corrupts header_details
 */
static int command_io_fifo_get_status( int argc, unsigned int *args )
{
    unsigned int s;
    int i;
...
/*f command_io_fifo_get_data
  ...
  corrupts header_details
 */
static int command_io_fifo_get_data( int argc, unsigned int *args )
{
    unsigned int s;
    int i;
 ...
 */
static int command_io_fifo_put_data( int argc, unsigned int *args )
{
    int i;
...
/*f command_postbus_ptrs
  .. <command> <data>*
 */
static int command_postbus_ptrs( int argc, unsigned int *args )
{
    unsigned int s;
    GIP_POST_RXCFG_0( s );
    uart_tx_hex8( s );
...
/*f command_postbus_tx
  .. <command> <data>*
 */
static int command_postbus_tx( int argc, unsigned int *args )
{
    int i;
...
/*f command_eth_tx
  .. <byte_length> [<data>*]
 */
static int command_eth_tx( int argc, unsigned int *args )
{
    int i, j, k;
 ...
 */
static int command_eth_poll( int argc, unsigned int *args )
{
    unsigned int s;
 ...
 */
/*v monitor_ethernet_chain
 */
extern const t_command monitor_ethernet_cmds[];
const t_command monitor_ethernet_cmds[] =
{
