/*a Copyright
  ...
  This file 'c_io_fifos.cpp' copyright Embisi 2003, 2004
...
/*a Defines
 */
#define MAX_CMD_FIFOS (1)
#define MAX_STATUS_FIFOS (1)
#define MAX_TX_DATA_FIFOS (1)
#define MAX_RX_DATA_FIFOS (1)
...
enum
{
     ...
     cmd_fifo_cmd_add,
     cmd_fifo_tx_data_add,
     cmd_fifo_status_check,
     cmd_fifo_status_read,
     cmd_fifo_rx_data_check,
     cmd_fifo_rx_data_check_x,
     cmd_fifo_rx_data_read,
     cmd_wait,
     cmd_wait_until_cmd_e,
     cmd_wait_until_tx_data_e,
     cmd_wait_until_status_ne,
};
...
typedef enum 
{
    event_flag_empty,
    event_flag_full,
    event_flag_nearly_empty,
    event_flag_nearly_full,
} t_event_flag;

/*t t_io_fifos_event_data
 */
typedef struct t_io_fifos_event_data
{
    struct t_io_fifos_event_data *next_in_list;
    ...
    int timeout;
    int fired;
} t_io_fifos_event_data;

/*t t_io_fifos_posedge_int_clock_state
*/
typedef struct t_io_fifos_posedge_int_clock_state
{
    int cmd_fifo_do_cmd;
    int cmd_fifo_toggle;
    int tx_data_fifo_do_cmd;
    int tx_data_fifo_toggle;
    int status_fifo_do_cmd;
    int status_fifo_toggle;
    int rx_data_fifo_do_cmd;
    int rx_data_fifo_toggle;

    unsigned int cmd_fifo_read_data;
    unsigned int tx_data_fifo_read_data;
} t_io_fifos_posedge_int_clock_state;

/*t t_io_fifos_inputs
*/
typedef struct t_io_fifos_inputs
{
    unsigned int *int_reset;

    unsigned int *cmd_fifo_cmd;
    unsigned int *cmd_fifo_cmd_toggle;
    unsigned int *cmd_fifo_to_access;

    unsigned int *tx_data_fifo_cmd;
    unsigned int *tx_data_fifo_cmd_toggle;
    unsigned int *tx_data_fifo_to_access;

    unsigned int *status_fifo_cmd;
    unsigned int *status_fifo_cmd_toggle;
    unsigned int *status_fifo_to_access;
    unsigned int *status_fifo_write_data;

    unsigned int *rx_data_fifo_cmd;
    unsigned int *rx_data_fifo_cmd_toggle;
    unsigned int *rx_data_fifo_to_access;
    unsigned int *rx_data_fifo_write_data;

} t_io_fifos_inputs;

/*t t_io_fifos_combinatorials
*/
typedef struct t_io_fifos_combinatorials
{
...
public:
    ...
    t_sl_error_level c_io_fifos::reset_active_high_int_reset( void );
    void c_io_fifos::exec_file_instantiate_callback( struct t_sl_exec_file_data *file_data );
private:
    void c_io_fifos::run_exec_file( void );
    t_io_fifos_event_data *c_io_fifos::io_fifos_add_event( const char *reason, t_event_fifo event_fifo, int fifo_number, t_event_flag event_flag, int value, int timeout );
    c_engine *engine;
    void *engine_handle;
    ...
    t_io_fifos_event_data *event_list;

    t_io_fifos_inputs inputs;
    t_io_fifos_combinatorials combinatorials;
    t_io_fifos_posedge_int_clock_state next_posedge_int_clock_state;
    t_io_fifos_posedge_int_clock_state posedge_int_clock_state;
...
/*a Statics
 */
/*v io_fifos_file_cmds
 */
static t_sl_exec_file_cmd io_fifos_file_cmds[] =
{
...
/*v io_fifos_file_fns
 */
static t_sl_exec_file_fn io_fifos_file_fns[] =
{
     {fn_input,               "input",         'i', "s", "input(<name>)", ef_fn_eval_input },
     {sl_exec_file_fn_none, NULL,     0,   NULL, NULL },
};

/*f state_desc_io_fifos
*/
#define struct_offset( ptr, a ) (((char *)&(ptr->a))-(char *)ptr)
static t_io_fifos_posedge_int_clock_state *___io_fifos_posedge_int_clock__ptr;
static t_engine_state_desc state_desc_io_fifos_posedge_int_clock[] =
{
//    {"src_fsm", engine_state_desc_type_bits, NULL, struct_offset(___io_fifos_posedge_int_clock__ptr, src_fsm), {2,0,0,0}, {NULL,NULL,NULL,NULL} },
//    {"src_left", engine_state_desc_type_bits, NULL, struct_offset(___io_fifos_posedge_int_clock__ptr, src_left), {5,0,0,0}, {NULL,NULL,NULL,NULL} },
//    {"fc_credit", engine_state_desc_type_bits, NULL, struct_offset(___io_fifos_posedge_int_clock__ptr, src_channel_state[0].fc_credit), {32,0,0,0}, {NULL,NULL,NULL,NULL} },
    {"", engine_state_desc_type_none, NULL, 0, {0,0,0,0}, {NULL,NULL,NULL,NULL} }
};

/*a Static wrapper functions for io_fifos
*/
/*f io_fifos_instance_fn
*/
static t_sl_error_level io_fifos_instance_fn( c_engine *engine, void *engine_handle )
{
    c_io_fifos *mod;
    mod = new c_io_fifos( engine, engine_handle );
    if (!mod)
        return error_level_fatal;
    return error_level_okay;
}

/*f io_fifos_delete_fn - simple callback wrapper for the main method
*/
static t_sl_error_level io_fifos_delete_fn( void *handle )
{
    c_io_fifos *mod;
...
*/
static t_sl_error_level io_fifos_combinatorial_fn( void *handle )
{
    c_io_fifos *mod;
    mod = (c_io_fifos *)handle;
...
/*f io_fifos_preclock_posedge_int_clock_fn
*/
static t_sl_error_level io_fifos_preclock_posedge_int_clock_fn( void *handle )
{
    c_io_fifos *mod;
    mod = (c_io_fifos *)handle;
...
/*f io_fifos_clock_posedge_int_clock_fn
*/
static t_sl_error_level io_fifos_clock_posedge_int_clock_fn( void *handle )
{
    c_io_fifos *mod;
    mod = (c_io_fifos *)handle;
...
{
     c_io_fifos *cif;
     cif = (c_io_fifos *)handle;
     cif->exec_file_instantiate_callback( file_data );
}

/*f c_io_fifos::exec_file_instantiate_callback
 */
void c_io_fifos::exec_file_instantiate_callback( struct t_sl_exec_file_data *file_data )
{
...
/*f c_io_fifos::io_fifos_add_event
 */
t_io_fifos_event_data *c_io_fifos::io_fifos_add_event( const char *reason, t_event_fifo event_fifo, int fifo_number, t_event_flag event_flag, int value, int timeout )
{
     t_io_fifos_event_data *event;
     char name[1024];

     event = (t_io_fifos_event_data *)malloc(sizeof(t_io_fifos_event_data));
     if (!event)
          return NULL;
                    ...
                    else
                    {
                         ...
                         case cmd_fifo_status_check:
                             if (sl_fifo_remove_entry( status_fifos[args[0].integer], d ))
                             {
                                 ...
                                 {
                                     sprintf( buffer, "c_io_fifos:Status fifo entry %08x/%08x from status fifo %d has incorrect time (expected %08x)", d[0], d[1], args[0].integer, args[1].integer );
                                 ...
                                 {
                                     sprintf( buffer, "c_io_fifos:Status fifo entry %08x/%08x from status fifo %d has incorrect data (expected %08x)", d[0], d[1], args[0].integer, args[2].integer );
                                     engine->message->add_error( NULL, error_level_info, error_number_sl_fail, error_id_sl_exec_file_allocate_and_read_exec_file,
                                                               error_arg_type_integer, engine->cycle(),
                                                               error_arg_type_malloc_string, buffer,
                                                               error_arg_type_malloc_string, engine->get_instance_name(engine_handle), 
                             ...
                             {
                                 sprintf( buffer, "c_io_fifos:Status fifo %d was empty", args[0].integer);
                                 engine->message->add_error( NULL, error_level_info, error_number_sl_fail, error_id_sl_exec_file_allocate_and_read_exec_file,
                                                           error_arg_type_integer, engine->cycle(),
                                                           error_arg_type_malloc_string, buffer,
                                                           error_arg_type_malloc_string, engine->get_instance_name(engine_handle), 
                         ...
                         case cmd_fifo_rx_data_check:
                             for (i=0; i<args[1].integer; i++)
                             {
                                 if (sl_fifo_remove_entry( rx_data_fifos[args[0].integer], d ))
                                 {
                                     ...
                                     {
                                         sprintf( buffer, "c_io_fifos:Rx data fifo entry %08x from rx data fifo %d has incorrect data (expected %08x)", d[0], args[0].integer, args[2+i].integer );
                                         engine->message->add_error( NULL, error_level_info, error_number_sl_fail, error_id_sl_exec_file_allocate_and_read_exec_file,
                                                                     error_arg_type_integer, engine->cycle(),
                                                                     error_arg_type_malloc_string, buffer,
                                                                     error_arg_type_malloc_string, engine->get_instance_name(engine_handle), 
                                 ...
                                 {
                                     sprintf( buffer, "c_io_fifos:Rx data fifo %d was empty", args[0].integer);
                                     engine->message->add_error( NULL, error_level_info, error_number_sl_fail, error_id_sl_exec_file_allocate_and_read_exec_file,
                                                                 error_arg_type_integer, engine->cycle(),
                                                                 error_arg_type_malloc_string, buffer,
                                                                 error_arg_type_malloc_string, engine->get_instance_name(engine_handle), 
                         ...
                         case cmd_fifo_rx_data_check_x:
                             for (i=0; i<args[1].integer; i+=2)
                             {
                                 if (sl_fifo_remove_entry( rx_data_fifos[args[0].integer], d ))
                                 {
                                     ...
                                     {
                                         sprintf( buffer, "c_io_fifos:Rx data fifo entry %08x from rx data fifo %d has incorrect data (expected %08x/%08x)", d[0], args[0].integer, args[2+i].integer, args[3+i].integer );
                                         engine->message->add_error( NULL, error_level_info, error_number_sl_fail, error_id_sl_exec_file_allocate_and_read_exec_file,
                                                                     error_arg_type_integer, engine->cycle(),
                                                                     error_arg_type_malloc_string, buffer,
                                                                     error_arg_type_malloc_string, engine->get_instance_name(engine_handle), 
                         ...
                         case cmd_fifo_rx_data_read:
                             ...
                             break;
                         case cmd_wait:
                             if ( (event = io_fifos_add_event( "wait", event_fifo_none, 0, event_flag_empty, 0, args[0].integer )) != NULL )
                             {
                         ...
                         case cmd_wait_until_cmd_e:
                             if ( (event = io_fifos_add_event( "wait_until_cmd_e", event_fifo_cmd, args[0].integer, event_flag_empty, 1, -1 )) != NULL )
                             {
                                 sl_exec_file_wait_for_event( exec_file_data, NULL, event->event );
                             }
                             break;
                         case cmd_wait_until_tx_data_e:
                             if ( (event = io_fifos_add_event( "wait_until_tx_data_e", event_fifo_tx_data, args[0].integer, event_flag_empty, 1, -1 )) != NULL )
                             {
                                 sl_exec_file_wait_for_event( exec_file_data, NULL, event->event );
                             }
                             break;
                         case cmd_wait_until_status_ne:
                             if ( (event = io_fifos_add_event( "wait_until_status_ne", event_fifo_status, args[0].integer, event_flag_empty, 0, -1 )) != NULL )
                             {
                                 sl_exec_file_wait_for_event( exec_file_data, NULL, event->event );
                             }
                             break;
...
/*a Constructors and destructors for io_fifos
*/
/*f c_io_fifos::c_io_fifos
...
c_io_fifos::c_io_fifos( class c_engine *eng, void *eng_handle )
{
    ...
    engine->register_delete_function( engine_handle, (void *)this, io_fifos_delete_fn );
    engine->register_reset_function( engine_handle, (void *)this, io_fifos_reset_fn );

    engine->register_comb_fn( engine_handle, (void *)this, io_fifos_combinatorial_fn );
    engine->register_clock_fns( engine_handle, (void *)this, "int_clock", io_fifos_preclock_posedge_int_clock_fn, io_fifos_clock_posedge_int_clock_fn );
...
//    engine->register_state_desc( engine_handle, 1, state_desc_io_fifos_posedge_int_clock, &posedge_int_clock_state, NULL );
    cycle_number = 0;
    reset_active_high_int_reset();
    if (exec_file_filename)
    {
        sl_exec_file_allocate_and_read_exec_file( engine->error, engine->message, internal_exec_file_instantiate_callback, (void *)this, "exec_file", exec_file_filename, &exec_file_data, "Test harness", io_fifos_file_cmds, io_fifos_file_fns );
    }
}
...
/*a Class reset/preclock/clock methods for io_fifos
*/
/*f c_io_fifos::reset
*/
t_sl_error_level c_io_fifos::reset( int pass )
...
/*f c_io_fifos::reset_active_high_int_reset
*/
t_sl_error_level c_io_fifos::reset_active_high_int_reset( void )
{
...
/*f c_io_fifos::evaluate_combinatorials
*/
t_sl_error_level c_io_fifos::evaluate_combinatorials( void )
{
    int i;
...
/*f c_io_fifos::preclock_posedge_int_clock
*/
t_sl_error_level c_io_fifos::preclock_posedge_int_clock( void )
{
...
/*f c_io_fifos__init
*/
extern void c_io_fifos__init( void )
{
    se_external_module_register( 1, "io_fifos", io_fifos_instance_fn );
}
...
/*f initio_fifos
*/
extern "C" void initio_fifos( void )
{
    c_io_fifos__init( );
    scripting_init_module( "io_fifos" );
}
